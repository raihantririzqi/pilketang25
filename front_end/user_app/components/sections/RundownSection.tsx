...
const biosData = [
    ...
    { time: "12:32", task: "PHASE_06: PENUTUP_&_VOTING_CORE", status: "[WAIT]" },
    { time: "14:17", task: "PHASE_07: AFTER_ACARA (CLEANUP)", status: "[END ]" }
];
                        ...
                        {biosData.map((item, index) => (
                            ...
                            >
                                ...
                                <motion.span
                                    ...
                                    className={`text-[10px] lg:text-lg font-bold whitespace-nowrap ml-2 ${item.status === '[ OK ]' ? 'text-green-500' :
