...
export default function LoginPage() {
    return (
        <section className="min-h-screen w-full bg-white flex flex-col items-center justify-center relative overflow-hidden p-4">
            ...
            <div className="absolute top-10 left-10 w-12 h-12 bg-green rounded-full border-4 border-black opacity-20 hidden lg:block"></div>
            <div className="absolute bottom-10 right-10 w-16 h-16 bg-magenta rounded-full border-4 border-black opacity-20 hidden lg:block"></div>
            ...
            >
                ...
                >
                    {/* Dekorasi Bintang di Sudut Kartu */}
                    ...
                    <Link href={googleAuthUrl} className="w-full block">
                        <div className="relative w-full h-14 cursor-pointer group">
                            {/* Layer Bayangan (Hitam) - Posisi Tetap */}
