  ...
  return (
    ...
    >
      <div className="w-full px-6 flex justify-between items-center mb-4">
        ...
        <button className="p-2 focus:outline-none" onClick={onClose}>
      ...
      <div className="flex flex-col items-center gap-6 font-retro text-xl w-full">
        {["Home", "Kandidat", "Feedback"].map((item) => (
          <div
            key={item}
            className="w-full text-center py-2 cursor-pointer hover:bg-gray-100/50 hover:text-blue-600 transition-colors"
            onClick={onClose}
          >
            {item}
          </div>
        ...
        <div className="relative w-40 h-12 cursor-pointer group mt-2" onClick={onClose}>
